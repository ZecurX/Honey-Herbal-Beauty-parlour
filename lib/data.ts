// Shared in-memory data storage for API routes
// In production, this would be replaced with a database (MongoDB, PostgreSQL, etc.)

import { GalleryItem, Enquiry, Service, Offer, Testimonial } from '@/types';
...
export let testimonialsData: Testimonial[] = [
    {
        ...
        rating: 5,
        imageUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&q=80',
        createdAt: '2024-12-01'
    },
    {
        id: '2',
        ...
        rating: 5,
        imageUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&q=80',
        createdAt: '2024-12-05'
    },
    {
        id: '3',
